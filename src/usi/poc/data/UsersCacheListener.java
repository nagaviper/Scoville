...
public class UsersCacheListener<K,V> extends CacheListenerAdapter<K,V> implements Declarable {

	public UsersCacheListener() {
		System.out.println("UsersCacheListener.UsersCacheListener()");
	}
